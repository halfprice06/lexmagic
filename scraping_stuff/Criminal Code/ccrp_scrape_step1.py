...
html_file_path = 'ccrp_html.html'  # Replace with the path to your HTML file
...
csv_file_path = 'ccrp_article_urls.csv'  # Name of the output CSV file
with open(csv_file_path, 'w', newline='', encoding='utf-8') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(['ccrp_article_number', 'URL', 'article_title'])  # Header row
